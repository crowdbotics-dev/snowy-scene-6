"""
Django settings for snowy_scene_6 project.
...
ROOT_URLCONF = 'snowy_scene_6.urls'
...
WSGI_APPLICATION = 'snowy_scene_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snowy_scene_6 API",
    "DESCRIPTION": "API documentation for snowy_scene_6 App",
    "VERSION": "v1",
}
